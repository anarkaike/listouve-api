...
/**
 * Migration para gerar a entidade listas de eventos
 */
return new class extends Migration
{
    ...
    {
        Schema::create(table: 'events_lists', callback: function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::table(table: 'events_lists', callback: function (Blueprint $table) {
