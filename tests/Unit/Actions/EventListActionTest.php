...
class EventListActionTest extends TestCase
{
    ...
    public function check_if_return_list_all_is_correct(): void
    {
        ...
        $repositoryMocked = Mockery::mock(args: EventListRepository::class)->makePartial();
        $repositoryMocked->shouldReceive(methodNames: 'listAll')->andReturn(args: $expectedValue);


        $actionToTest = new EventListAction(repository: $repositoryMocked);
    ...
    /**
     * Verifica se o metodo EventListAction->findById(id: $id) retorna o valor correto
     * @test
    ...
    public function check_if_return_find_by_id_is_correct(): void
    {
        ...
        $modelMockedExpected = $this->createPartialMock(originalClassName: EventList::class, methods: ['fill', 'setAttribute']);
        $modelMockedExpected->id = $idToFind;
        $modelMockedExpected->event_id = fake()->randomNumber(1,9999);
    ...
    /**
     * Verifica se o metodo EventListAction->create(data: $data, createdBy: $createdBy) retorna o valor correto
     * @test
     * @throws \PHPUnit\Framework\MockObject\Exception
     */
    ...
    /**
     * Verifica se o metodo EventListAction->update(data: $data, updatedBy: $updatedBy) retorna o valor correto
     * @test
     * @throws \PHPUnit\Framework\MockObject\Exception
     */
    ...
    /**
     * Verifica se o metodo EventListAction->delete(id: $id, deletedBy: $deletedBy) retorna o valor correto
     * @test
     * @throws \PHPUnit\Framework\MockObject\Exception
     */
