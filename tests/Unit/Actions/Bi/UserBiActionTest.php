...
use App\Models\User;
use App\Repositories\Bi\UserBiRepository;
use Mockery;
use PHPUnit\Framework\TestCase;

class UserBiActionTest extends TestCase
{

    /**
     * Verifica se o metodo UserBiAction->getTotal() retorna o valor correto
     * @test
     */
    public function check_if_return_get_total_is_correct(): void
    {
        ...
        $repositoryMocked = Mockery::mock(args: UserBiRepository::class)->makePartial();
        $repositoryMocked->shouldReceive(methodNames: 'getTotal')->andReturn(args: $expectedValue);


        $actionToTest = new UserBiAction(repository: $repositoryMocked);
