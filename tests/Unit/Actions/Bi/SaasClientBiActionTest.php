...
class SaasClientBiActionTest extends TestCase
{
    ...
    /**
     * Verifica se o metodo SaasClientBiAction->getTotal() retorna o valor correto
     * @test
     */
    public function check_if_return_get_total_is_correct(): void
    {
        ...
        $repositoryMocked = Mockery::mock(args: SaasClientBiRepository::class)->makePartial();
        $repositoryMocked->shouldReceive(methodNames: 'getTotal')->andReturn(args: $expectedValue);


        $actionToTest = new SaasClientBiAction(repository: $repositoryMocked);
