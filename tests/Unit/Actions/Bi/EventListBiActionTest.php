...
use App\Enums\EventList\EventListStatusEnum;
use App\Models\EventList;
use App\Repositories\Bi\EventListBiRepository;
use Mockery;
use PHPUnit\Framework\TestCase;

class EventListBiActionTest extends TestCase
{

    /**
     * Verifica se o metodo EventListBiAction->getTotal() retorna o valor correto
     * @test
     */
    public function check_if_return_get_total_is_correct(): void
    {
        ...
        $repositoryMocked = Mockery::mock(args: EventListBiRepository::class)->makePartial();
        $repositoryMocked->shouldReceive(methodNames: 'getTotal')->andReturn(args: $expectedValue);


        $actionToTest = new EventListBiAction(repository: $repositoryMocked);
