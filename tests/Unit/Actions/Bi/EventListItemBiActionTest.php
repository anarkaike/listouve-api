...
use App\Enums\EventListItem\EventListItemStatusEnum;
use App\Models\EventListItem;
use App\Repositories\Bi\EventListItemBiRepository;
use Mockery;
use PHPUnit\Framework\TestCase;

class EventListItemBiActionTest extends TestCase
{

    /**
     * Verifica se o metodo EventListItemBiAction->getTotal() retorna o valor correto
     * @test
     */
    public function check_if_return_get_total_is_correct(): void
    {
        ...
        $repositoryMocked = Mockery::mock(args: EventListItemBiRepository::class)->makePartial();
        $repositoryMocked->shouldReceive(methodNames: 'getTotal')->andReturn(args: $expectedValue);


        $actionToTest = new EventListItemBiAction(repository: $repositoryMocked);
