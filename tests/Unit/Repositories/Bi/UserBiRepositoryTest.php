...
use App\{
    Models\User,
    Repositories\Bi\UserBiRepository,
};

class UserBiRepositoryTest extends TestCase
{
    /**
     * Verifica se o metodo UserBiRepository->getTotal() retorna o valor correto
     * @test
     */
    public function check_if_return_get_total_is_correct(): void
    {
        ...
        $repositoryToTest = new UserBiRepository(user: $modelMocked);
    ...
    /**
     * Verifica se o metodo UserBiRepository->getTotalRegisteredToday() retorna o valor correto
     * @test
     */
    ...
    /**
     * Verifica se o metodo UserRepository->getTotalRgisteredThisWeek() retorna o valor correto
     * @test
     */
    ...
    /**
     * Verifica se o metodo UserRepository->getTotal() retorna o valor correto
     * @test
     */
