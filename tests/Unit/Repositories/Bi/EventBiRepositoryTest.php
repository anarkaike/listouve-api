...
use App\{
    Models\Event,
    Repositories\Bi\EventBiRepository,
};

class EventBiRepositoryTest extends TestCase
{
    /**
     * Verifica se o metodo EventBiRepository->getTotal() retorna o valor correto
     * @test
     */
    public function check_if_return_get_total_is_correct(): void
    {
        ...
        $repositoryToTest = new EventBiRepository(event: $modelMocked);
    ...
    /**
     * Verifica se o metodo EventBiRepository->getTotalRegisteredToday() retorna o valor correto
     * @test
     */
    ...
    /**
     * Verifica se o metodo EventRepository->getTotalRgisteredThisWeek() retorna o valor correto
     * @test
     */
    ...
    /**
     * Verifica se o metodo EventRepository->getTotal() retorna o valor correto
     * @test
     */
