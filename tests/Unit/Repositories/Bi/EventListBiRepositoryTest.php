...
use App\{
    Models\EventList,
    Repositories\Bi\EventListBiRepository,
};
...
class EventListBiRepositoryTest extends TestCase
{
    ...
    public function check_if_return_get_total_is_correct(): void
    {
        ...
        $repositoryToTest = new EventListBiRepository(eventList: $modelMocked);
    ...
    /**
     * Verifica se o metodo EventListBiRepository->getTotalRegisteredToday() retorna o valor correto
     * @test
     */
    ...
    /**
     * Verifica se o metodo EventListRepository->getTotalRgisteredThisWeek() retorna o valor correto
     * @test
     */
    ...
    /**
     * Verifica se o metodo EventListRepository->getTotal() retorna o valor correto
     * @test
     */
