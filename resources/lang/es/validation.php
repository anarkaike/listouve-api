...
return [
    ...
    | la clase validadora. Algunas de estas reglas tienen versiones múltiples, como
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Líneas de Idioma Personalizadas de Validación
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    | por algo más fácil de leer, como "Dirección de Correo Electrónico" en lugar de "email". Esto simplemente nos ayuda a hacer nuestro mensaje más expresivo.
    |
    */
