...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Mensagens de Idioma de Validação
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'date_format' => 'O campo :attribute deve corresponder ao formato :formato.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Mensagens de Idioma de Validação Personalizadas
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    | por algo mais fácil de ler, como "Endereço de E-Mail" em vez de "email". Isso simplesmente nos ajuda a tornar nossa mensagem mais expressiva.
    |
    */
