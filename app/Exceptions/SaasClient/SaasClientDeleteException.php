...
/**
 * Classe de exceção para erro generico de exclusão de um usuário do saas
 */
class SaasClientDeleteException extends BaseException
{
    /**
    ...
    /**
     * Mensagem padrão para erro de exclusão de um usuário do saas
     *
     * @return string
     */
