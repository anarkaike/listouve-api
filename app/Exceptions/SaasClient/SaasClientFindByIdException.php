...
/**
 * Classe de exceção para erro generico de busca de usuário do saas
 */
class SaasClientFindByIdException extends BaseException
{
    /**
    ...
    /**
     * Mensagem padrão para erro de busca de usuário do saas por ID
     *
     * @return string
     */
