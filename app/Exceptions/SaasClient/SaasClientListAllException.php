...
/**
 * Classe de exceção para erro generico de listagem de usuários do saas
 */
class SaasClientListAllException extends BaseException
{
    /**
    ...
    /**
     * Mensagem padrão para erro de listagem de usuários do saas
     *
     * @return string
     */
