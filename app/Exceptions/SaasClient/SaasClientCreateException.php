...
/**
 * Classe de exceção para erro generico de criação de um usuário do saas
 */
class SaasClientCreateException extends BaseException
{
    /**
    ...
    /**
     * Mensagem padrão para erro de criação de um usuário para o saas
     *
     * @return string
     */
