...
/**
 * Classe de exceção para erro generico de listagem de listas de evento
 */
class EventListListAllException extends BaseException
{
    /**
    ...
    /**
     * Mensagem padrão para erro de listagem de listas de eventos
     *
     * @return string
     */
    public function getDefaultMessage()
    {
        return 'Erro ao tentar listar todos as listas de eventos.';
    }
}
