...
namespace App\Exceptions\EventList;
...
/**
 * Classe de exceção para erro generico de busca de lista de evento
 */
class EventListFindByIdException extends BaseException
{
    /**
    ...
    /**
     * Mensagem padrão para erro de busca de lista de evento por ID
     *
     * @return string
     */
    public function getDefaultMessage()
    {
        return 'Erro ao tentar recuperar um lista de evento pelo ID.';
    }
}
