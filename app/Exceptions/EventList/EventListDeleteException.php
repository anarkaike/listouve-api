...
/**
 * Classe de exceção para erro generico de exclusão de lista de evento
 */
class EventListDeleteException extends BaseException
{
    /**
    ...
    /**
     * Mensagem padrão para erro de exclusão de lista de evento
     *
     * @return string
     */
    public function getDefaultMessage()
    {
        return trans(key: 'messages.events_lists.delete_error');
    }
}
