...
/**
 * Classe de exceção para erro generico de busca de evento por ID
 */
class EventFindByIdException extends BaseException
{
    /**
    ...
    /**
     * Mensagem padrão para erro de busca de evento por ID
     *
     * @return string
     */
