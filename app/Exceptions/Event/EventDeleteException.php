...
/**
 * Classe de exceção para erro generico de exclusão de evento
 */
class EventDeleteException extends BaseException
{
    /**
    ...
    /**
     * Mensagem padrão para erro de exclusão de evento
     *
     * @return string
     */
