...
/**
 * Classe de exceção para erro generico de atualização de eventos
 */
class EventNotFountException extends BaseException
{
    /**
    ...
    /**
     * Mensagem padrão para erro de atualização de evento
     *
     * @return string
     */
