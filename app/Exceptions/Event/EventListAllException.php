...
/**
 * Classe de exceção para erro generico de listagem de eventos
 */
class EventListAllException extends BaseException
{
    /**
    ...
    /**
     * Mensagem padrão para erro de listagem de eventos
     *
     * @return string
     */
