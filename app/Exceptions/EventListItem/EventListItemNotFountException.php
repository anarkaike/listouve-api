...
/**
 * Classe de exceção para erro generico de atualização de lista de eventos
 */
class EventListItemNotFountException extends BaseException
{
    /**
    ...
    /**
     * Mensagem padrão para erro de atualização de lista de evento
     *
     * @return string
     */
    public function getDefaultMessage()
    {
        return trans(key: 'messages.events_lists_items.no_records_found');
    }
}
