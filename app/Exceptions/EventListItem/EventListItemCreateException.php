...
/**
 * Classe de exceção para erro generico de criação de lista de evento
 */
class EventListItemCreateException extends BaseException
{
    /**
    ...
    /**
     * Mensagem padrão para erro de criação de lista de evento
     *
     * @return string
     */
    public function getDefaultMessage()
    {
        return trans(key: 'messages.events_lists_items.create_error');
    }
}
